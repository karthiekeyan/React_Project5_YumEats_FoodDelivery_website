...
import {MdHelp,
        MdOutlineFavorite} from 'react-icons/md'
      ...
      <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center '>
            ...
            <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
                ...
                <p className='p-2 cursor-pointer text-bold'>Delivery</p>
            </div>
        </div>
        ...
        <button className='bg-orange-700 cursor-pointer text-white hidden md:flex items-center py-2 rounded-full border-none'>
