...
const Meal = () => {
  ...
  return (
    <div className='max-w-[1520px] m-auto px-4 py-12'>
        ...
        <div className='grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 gap-6 mt-3'>
            {
                foods.map((item)=>(
                    ...
                    <div className='flex justify-between py-2 px-2'>
                        ...
                        <p className='bg-orange-700 h-18 w-18 rounded-full cursor-pointer -mt-10 text-white py-3 px-2 border-8 font-bold'>
                        {item.price}
                        </p>
                    </div>

                    <div className='pl-2 py-4 -mt-5'>
                        <p className='flex items-center cursor-pointer text-indigo-600 '>View More<ArrowSmRightIcon className='w-5 ml-2'/></p>
                    </div>
                </div>
            ))
        }
